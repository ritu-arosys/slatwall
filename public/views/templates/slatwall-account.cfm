									...
									<div class="col-md-4">
										...
										<form action="?s=1" method="post">
											...
											<div class="form-group">
												...
												<sw:FormField type="text" valueObject="#$.slatwall.getAccount()#" valueObjectProperty="firstName" class="col-md-4 form-control" />
												<p class="help-block"><sw:ErrorDisplay object="#$.slatwall.getAccount()#" errorName="firstName" /></p>
											</div>

											<!--- Last Name --->
											<div class="form-group">
												<label for="lastName">Last Name</label>
												<sw:FormField type="text" valueObject="#$.slatwall.getAccount()#" valueObjectProperty="lastName" class="col-md-4 form-control" />
												<p class="help-block"><sw:ErrorDisplay object="#$.slatwall.getAccount()#" errorName="lastName" /></p>
											</div>
											...
											<cfif arrayLen(accountAttributeSets)>
												...
												<cfloop array="#accountAttributeSets#" index="attributeSet">
													...
													<cfloop array="#attributeSet.getAttributes()#" index="attribute">
														...
														<div class="form-group">
															<label>#attribute.getAttributeName()#</label>
															<sw:FormField type="#attribute.getFormFieldType()#" name="#attribute.getAttributeCode()#" valueObject="#attributeValueObject#" valueObjectProperty="attributeValue" valueOptions="#attributeValueObject.getAttributeValueOptions()#" class="col-md-4 form-control" />
															<p class="help-block"><sw:ErrorDisplay object="#attributeValueObject#" errorName="password" /></p>
														</div>
										...
										<form action="?s=1" method="post">
											...
											<div class="form-group">
												...
												<sw:FormField type="password" valueObject="#changePasswordObj#" valueObjectProperty="password" class="col-md-4 form-control" />
												<p class="help-block"><sw:ErrorDisplay object="#changePasswordObj#" errorName="password" /></p>
											</div>

											<!--- Confirm New Password --->
											<div class="form-group">
												<label for="password">Confirm New Password</label>
												<sw:FormField type="password" valueObject="#changePasswordObj#" valueObjectProperty="passwordConfirm" class="col-md-4 form-control" />
												<p class="help-block"><sw:ErrorDisplay object="#changePasswordObj#" errorName="passwordConfirm" /></p>
											</div>
											...
											<div class="col-md-4">
															...
															<td>
																...
																<div class="apn#accountPhoneNumberIndex#<cfif not accountPhoneNumber.hasErrors()> hide</cfif>">
																	...
																	<form action="?s=1" method="post">
																		...
																		<!--- Phone Number --->
																		<div class="form-group">
																			<sw:FormField type="text" name="accountPhoneNumbers[1].phoneNumber" valueObject="#accountPhoneNumber#" valueObjectProperty="phoneNumber" class="col-md-3 form-control" />
																			<p class="help-block"><sw:ErrorDisplay object="#changePasswordObj#" errorName="passwordConfirm" /></p>
																		</div>
												...
												<form action="?s=1" method="post">
													...
													<div class="form-group">
														...
														<sw:FormField type="text" name="accountPhoneNumbers[1].phoneNumber" valueObject="#newAccountPhoneNumber#" valueObjectProperty="phoneNumber" fieldAttributes='placeholder="Add Phone Number"' class="col-md-3 form-control" />
														<p class="help-block"><sw:ErrorDisplay object="#newAccountPhoneNumber#" errorName="phoneNumber" /></p>
													</div>
											...
											<div class="col-md-4">
															...
															<td>
																...
																<div class="aea#accountEmailAddressIndex#<cfif not accountEmailAddress.hasErrors()> hide</cfif>">
																	...
																	<form action="?s=1" method="post">
																		...
																		<div class="form-group">
																			<label for=""></label>
																			<sw:FormField type="text" name="accountEmailAddresses[1].emailAddress" valueObject="#accountEmailAddress#" valueObjectProperty="emailAddress" class="col-md-3 form-control" />
																			<p class="help-block"><sw:ErrorDisplay object="#accountEmailAddress#" errorName="emailAddress" /></p>
																		</div>
												...
												<form action="?s=1" method="post">
													...
													<div class="form-group">
														...
														<sw:FormField type="text" name="accountEmailAddresses[1].emailAddress" valueObject="#newAccountEmailAddress#" valueObjectProperty="emailAddress" fieldAttributes='placeholder="Add Email Address"' class="col-md-3 form-control" />
														<p class="help-block"><sw:ErrorDisplay object="#newAccountEmailAddress#" errorName="emailAddress" /></p>
													</div>
														...
														<div class="aa#accountAddressIndex#<cfif not accountAddress.hasErrors()> hide</cfif>">
															...
															<form action="?s=1" method="post">
																...
																<div class="form-group">
																	...
																	<sw:FormField type="text" name="accountAddresses[1].accountAddressName" valueObject="#accountAddress#" valueObjectProperty="accountAddressName" class="col-md-3 form-control" />
																	<p class="help-block"><sw:ErrorDisplay object="#accountAddress#" errorName="accountAddressName" /></p>
																</div>

																<!--- Address --->
																<div class="form-group">
																	<sw:AddressForm address="#accountAddress.getAddress()#" fieldNamePrefix="accountAddresses[1].address." fieldClass="col-md-3 form-control" />
																</div>
															...
															<div class="accordion-inner">
																...
																<form action="?s=1" method="post">
																	...
																	<div class="form-group">
																		...
																		<sw:FormField type="text" name="accountAddresses[1].accountAddressName" valueObject="#newAccountAddress#" valueObjectProperty="accountAddressName" class="col-md-3" />
																		<p class="help-block"><sw:ErrorDisplay object="#newAccountAddress#" errorName="accountAddressName" /></p>
																	</div>

																	<!--- New Address --->
																	<sw:AddressForm id="newAccountAddress" address="#newAccountAddress.getAddress()#" fieldNamePrefix="accountAddresses[1].address." fieldClass="col-md-3" />
													...
													<div class="thumbnail">
														...
														<div class="apm#accountPaymentMethodIndex#<cfif not accountPaymentMethod.hasErrors()> hide</cfif>">
															...
															<form action="?s=1" method="post">
																...
																<div class="form-group">
																	<label for="firstName">Nickname</label>
																	<sw:FormField type="text" name="accountPaymentMethods[1].accountPaymentMethodName" valueObject="#accountPaymentMethod#" valueObjectProperty="accountPaymentMethodName" class="col-md-3 form-control" />
																	<p class="help-block"><sw:ErrorDisplay object="#accountPaymentMethod#" errorName="accountPaymentMethodName" /></p>
																</div>
																...
																<cfif accountPaymentMethod.getPaymentMethod().getPaymentMethodType() eq "creditCard">
																	...
																	<div class="form-group">
																		...
																		<sw:FormField type="text" name="accountPaymentMethods[1].creditCardNumber" valueObject="#accountPaymentMethod#" valueObjectProperty="creditCardNumber" class="col-md-3 form-control" />
																		<p class="help-block"><sw:ErrorDisplay object="#accountPaymentMethod#" errorName="creditCardNumber" /></p>
																	</div>

																	<!--- Name on Credit Card --->
																	<div class="form-group">
																		<label for="firstName">Name on Credit Card</label>
																		<sw:FormField type="text" name="accountPaymentMethods[1].nameOnCreditCard" valueObject="#accountPaymentMethod#" valueObjectProperty="nameOnCreditCard" class="col-md-3 form-control" />
																		<p class="help-block"><sw:ErrorDisplay object="#accountPaymentMethod#" errorName="nameOnCreditCard" /></p>
																	</div>
																	...
																	<div class="row">
																		...
																		<div class="col-md-1">
																			...
																			<!--- Security Code --->
																			<div class="form-group">
																				<label for="rating">CVV</label>
																				<sw:FormField type="text" name="accountPaymentMethods[1].securityCode" valueObject="#accountPaymentMethod#" valueObjectProperty="securityCode" class="col-md-1 form-control" />
																				<p class="help-block"><sw:ErrorDisplay object="#accountPaymentMethod#" errorName="securityCode" /></p>
																			</div>
																		...
																		<div class="col-md-2">
																			...
																			<!--- Expiration --->
																			<div class="form-group">
																				<label for="rating">Exp. (MM/YYYY)</label>
																				<sw:FormField type="select" name="accountPaymentMethods[1].expirationMonth" valueObject="#accountPaymentMethod#" valueObjectProperty="expirationMonth" valueOptions="#accountPaymentMethod.getExpirationMonthOptions()#" class="col-md-1 form-control" />
																				<sw:FormField type="select" name="accountPaymentMethods[1].expirationYear" valueObject="#accountPaymentMethod#" valueObjectProperty="expirationYear" valueOptions="#accountPaymentMethod.getExpirationYearOptions()#" class="col-md-1 form-control" />
																				<p class="help-block"><sw:ErrorDisplay object="#accountPaymentMethod#" errorName="expirationMonth" /></p>
																				<p class="help-block"><sw:ErrorDisplay object="#accountPaymentMethod#" errorName="expirationYear" /></p>
																			</div>
																	...
																	<!--- Billing Address --->
																	<sw:AddressForm id="newBillingAddress" address="#accountPaymentMethod.getBillingAddress()#" fieldNamePrefix="accountPaymentMethods[1].billingAddress." fieldClass="col-md-3" />
																<cfelseif accountPaymentMethod.getPaymentMethod().getPaymentMethodType() eq "external">
																...
																<cfelseif accountPaymentMethod.getPaymentMethod().getPaymentMethodType() eq "giftCard">
																	...
																	<!--- Gift Card Number --->
																	<div class="form-group">
																		<label for="firstName">Gift Card Number</label>
																		<sw:FormField type="text" name="accountPaymentMethods[1].giftCardNumber" valueObject="#accountPaymentMethod#" valueObjectProperty="giftCardNumber" class="col-md-3 form-control" />
																		<p class="help-block"><sw:ErrorDisplay object="#accountPaymentMethod#" errorName="giftCardNumber" /></p>
																	</div>
																...
																<div id="#pmID#" class="accordion-body collapse<cfif newAccountPaymentMethod.hasErrors() and not isNull(newAccountPaymentMethod.getPaymentMethod()) and newAccountPaymentMethod.getPaymentMethod().getPaymentMethodID() eq paymentMethod.getPaymentMethodID()> in</cfif>">
																	...
																	<div class="accordion-inner">
																		...
																		<form action="?s=1" method="post">
																			...
																			<div class="form-group">
																				<label for="firstName">Nickname</label>
																				<sw:FormField type="text" name="accountPaymentMethodName" valueObject="#newAccountPaymentMethod#" valueObjectProperty="accountPaymentMethodName" class="col-md-3 form-control" />
																				<p class="help-block"><sw:ErrorDisplay object="#newAccountPaymentMethod#" errorName="accountPaymentMethodName" /></p>
																			</div>
																			...
																			<cfif paymentMethod.getPaymentMethodType() eq "creditCard">
																				...
																				<div class="form-group">
																					<label for="firstName">Credit Card Number</label>
																					<sw:FormField type="text" name="creditCardNumber" valueObject="#newAccountPaymentMethod#" valueObjectProperty="creditCardNumber" class="col-md-3" />
																					<p class="help-block"><sw:ErrorDisplay object="#newAccountPaymentMethod#" errorName="creditCardNumber" /></p>
																				</div>

																				<!--- Name on Credit Card --->
																				<div class="form-group">
																					<label for="firstName">Name on Credit Card</label>
																					<sw:FormField type="text" name="nameOnCreditCard" valueObject="#newAccountPaymentMethod#" valueObjectProperty="nameOnCreditCard" class="col-md-3 form-control" />
																					<p class="help-block"><sw:ErrorDisplay object="#newAccountPaymentMethod#" errorName="nameOnCreditCard" /></p>
																				</div>
																				...
																				<div class="row">
																					...
																					<div class="col-md-1">
																						...
																						<div class="form-group">
																							<label for="rating">CVV</label>
																							<sw:FormField type="text" name="securityCode" valueObject="#newAccountPaymentMethod#" valueObjectProperty="securityCode" class="col-md-1 form-control" />
																							<p class="help-block"><sw:ErrorDisplay object="#newAccountPaymentMethod#" errorName="securityCode" /></p>
																						</div>
																					...
																					<div class="col-md-2">
																						...
																						<div class="form-group">
																							<label for="rating">Exp. (MM/YYYY)</label>
																							<sw:FormField type="select" name="expirationMonth" valueObject="#newAccountPaymentMethod#" valueObjectProperty="expirationMonth" valueOptions="#newAccountPaymentMethod.getExpirationMonthOptions()#" class="col-md-1 form-control" />
																							<sw:FormField type="select" name="expirationYear" valueObject="#newAccountPaymentMethod#" valueObjectProperty="expirationYear" valueOptions="#newAccountPaymentMethod.getExpirationYearOptions()#" class="col-md-1 form-control" />
																							<p class="help-block"><sw:ErrorDisplay object="#newAccountPaymentMethod#" errorName="expirationMonth" /></p>
																							<p class="help-block"><sw:ErrorDisplay object="#newAccountPaymentMethod#" errorName="expirationYear" /></p>
																						</div>
																					</div>
																				</div>
																				...
																				<!--- Billing Address --->
																				<sw:AddressForm id="newBillingAddress" address="#newAccountPaymentMethod.getBillingAddress()#" fieldNamePrefix="billingAddress." fieldClass="col-md-3" />
																			...
																			<cfelseif paymentMethod.getPaymentMethodType() eq "giftCard">
																				...
																				<div class="form-group">
																					<label for="firstName">Gift Card Number</label>
																					<sw:FormField type="text" name="giftCardNumber" valueObject="#newAccountPaymentMethod#" valueObjectProperty="giftCardNumber" class="col-md-3 form-control" />
																					<p class="help-block"><sw:ErrorDisplay object="#newAccountPaymentMethod#" errorName="giftCardNumber" /></p>
																				</div>
																...
																<div class="well">
																	...
																	<form action="?s=1" method="post">
																		...
																		<div class="form-group">
																			...
																			<p class="help-block"><sw:ErrorDisplay object="#subscriptionUsage#" errorName="accountPaymentMethod" /></p>
																		</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<form action="?s=1&swprid=#url.swprid#" method="post">
						...
						<!--- New Password --->
						<div class="form-group">
							<label for="passwird">New Password</label>
							<sw:FormField type="password" valueObject="#resetPasswordObj#" valueObjectProperty="password" class="col-md-6 form-control" />
							<p class="help-block"><sw:ErrorDisplay object="#resetPasswordObj#" errorName="password" /></p>
						</div>

						<!--- Confirm Password --->
						<div class="form-group">
							<label for="rating">Confirm Password</label>
							<sw:FormField type="password" valueObject="#resetPasswordObj#" valueObjectProperty="passwordConfirm" class="col-md-6 form-control" />
							<p class="help-block"><sw:ErrorDisplay object="#resetPasswordObj#" errorName="passwordConfirm" /></p>
						</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<form action="?s=1" method="post">
						...
						<!--- Email Address --->
						<div class="form-group">
							<label for="rating">Email Address</label>
							<sw:FormField type="text" valueObject="#accountLoginObj#" valueObjectProperty="emailAddress" class="col-md-6 form-control" />
						...
						<div class="form-group">
							...
							<sw:FormField type="password" valueObject="#accountLoginObj#" valueObjectProperty="password" class="col-md-6 form-control" />
					...
					<form action="?s=1" method="post">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label for="firstName">First Name</label>
									<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="firstName" class="col-md-3 form-control" />
							...
							<div class="col-md-3">
								<div class="form-group">
									<label for="lastName">Last Name</label>
									<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="lastName" class="col-md-3 form-control" />
						...
						<div class="form-group">
							...
							<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="phoneNumber" class="col-md-6 form-control" />
						...
						<div class="form-group">
							<label for="email">Email Address</label>
							<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="emailAddress" class="col-md-6 form-control" />
						...
						<div class="fomr-group">
							...
							<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="emailAddressConfirm" class="col-md-6 form-control" />
						...
						<div class="form-group">
							<label for="password">Password</label>
							<sw:FormField type="password" valueObject="#createAccountObj#" valueObjectProperty="password" class="col-md-6 form-control" />
						...
						<div class="form-group">
							...
							<sw:FormField type="password" valueObject="#createAccountObj#" valueObjectProperty="passwordConfirm" class="col-md-6 form-control" />
							<p class="help-block"><sw:ErrorDisplay object="#createAccountObj#" errorName="password" /></p>
						</div>
