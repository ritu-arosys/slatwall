							...
							<div class="col-md-4">
								...
								<form action="?s=1" method="post">
			    					...
			    					<label for="emailAddress">Email Address</label>
										<sw:FormField type="text" valueObject="#accountLoginObj#" valueObjectProperty="emailAddress" class="col-md-4" />
				    				...
				    				<label for="password">Password</label>
										<sw:FormField type="password" valueObject="#accountLoginObj#" valueObjectProperty="password" class="col-md-4 form-control" />
								...
								<form action="?s=1" method="post">
									...
									<div class="form-group">
			    					<label for="emailAddress">Email Address</label>
										<sw:FormField type="text" valueObject="#accountLoginObj#" valueObjectProperty="emailAddress" class="col-md-4 control-group" />
							...
							<div class="col-md-4">
								...
								<form action="?s=1" method="post">
									...
									<div class="row">
										...
										<div class="col-md-2">
					    					...
					    					<label for="firstName">First Name</label>
												<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="firstName" class="col-md-2 control-group" />
										...
										<div class="col-md-2">
					    					...
					    					<label for="lastName">Last Name</label>
												<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="lastName" class="col-md-2 control-group" />
			    					...
			    					<label for="phoneNumber">Phone Number</label>
										<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="phoneNumber" class="col-md-4 control-group" />
									...
									<div class="form-group">
			    					<label for="emailAddress">Email Address</label>
										<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="emailAddress" class="col-md-4 control-group" />
			    					...
			    					<label for="emailAddressConfirm">Confirm Email Address</label>
										<sw:FormField type="text" valueObject="#createAccountObj#" valueObjectProperty="emailAddressConfirm" class="col-md-4 control-group" />
			    					...
			    					<label for="createAuthenticationFlag">Save Account ( No for Guest Checkout )</label>
										...
										<p class="help-block"><sw:ErrorDisplay object="#createAccountObj#" errorName="createAuthenticationFlag" />	</p>
			  					</div>
									...
									<div id="password-details" >
										<div class="form-group">
				    					<label for="password">Password</label>
											<sw:FormField type="password" valueObject="#createAccountObj#" valueObjectProperty="password" class="col-md-4 control-group" />
				    					...
				    					<label for="passwordConfirm">Confirm Password</label>
											<sw:FormField type="password" valueObject="#createAccountObj#" valueObjectProperty="passwordConfirm" class="col-md-4 control-group" />
											<p class="help-block"><sw:ErrorDisplay object="#createAccountObj#" errorName="password" /></p>
				  					</div>
									</div>
									...
									<div class="row">
										...
										<cfif orderFulfillment.getFulfillmentMethod().getFulfillmentMethodType() eq "email">
											...
											<div class="col-md-8">
												...
												<div class="form-group">
						    					<label for="emailAddress">Email Address</label>
													<sw:FormField type="text" name="orderFulfillments[#orderFulfillmentIndex#].emailAddress" valueObject="#orderFulfillment#" valueObjectProperty="emailAddress" class="col-md-4 control-group" />
													<p class="help-block"><sw:ErrorDisplay object="#orderFulfillment#" errorName="emailAddress" /></p>
						  					</div>
											</div>
										...
										<cfelseif orderFulfillment.getFulfillmentMethod().getFulfillmentMethodType() eq "pickup">
											...
											<div class="col-md-8">
						    					...
						    					<label for="pickupLocation">Pickup Location</label>
													<sw:FormField type="select" name="orderFulfillments[#orderFulfillmentIndex#].pickupLocation.locationID" valueObject="#orderFulfillment#" valueObjectProperty="pickupLocation" valueOptions="#orderFulfillment.getPickupLocationOptions()#" class="col-md-4 control-group" />
													<p class="help-block"><sw:ErrorDisplay object="#orderFulfillment#" errorName="pickupLocation" /></p>
						  					</div>
											</div>
											...
											<div class="col-md-4">
												...
												<cfif arrayLen(accountAddressOptions) gt 1>
							    					...
							    					<label for="accountAddress">Select Address</label>
														<sw:FormField type="select" name="orderFulfillments[#orderFulfillmentIndex#].accountAddress.accountAddressID" valueObject="#orderFulfillment#" valueObjectProperty="accountAddress" valueOptions="#accountAddressOptions#" value="#accountAddressID#" class="col-md-4 control-group" />
												...
												<div id="new-shipping-address#orderFulfillmentIndex#"<cfif len(accountAddressID)> class="hide"</cfif>>
													<cfif isNull(orderFulfillment.getAccountAddress())>
														<sw:AddressForm id="newShippingAddress" address="#orderFulfillment.getAddress()#" fieldNamePrefix="orderFulfillments[#orderFulfillmentIndex#].shippingAddress." fieldClass="col-md-4" />
													<cfelse>
														<sw:AddressForm id="newShippingAddress" address="#orderFulfillment.getNewPropertyEntity( 'shippingAddress' )#" fieldNamePrefix="orderFulfillments[#orderFulfillmentIndex#].shippingAddress." fieldClass="col-md-4" />
													</cfif>
													...
													<cfif not $.slatwall.getCart().getAccount().getGuestAccountFlag()>
														...
														<div id="save-account-address-name#orderFulfillmentIndex#"<cfif not orderFulfillment.getSaveAccountAddressFlag()> class="hide"</cfif>>
									    					...
									    					<label for="saveAccountAddressName">Address Nickname (optional)</label>
																<sw:FormField type="text" name="orderFulfillments[#orderFulfillmentIndex#].saveAccountAddressName" valueObject="#orderFulfillment#" valueObjectProperty="saveAccountAddressName" class="col-md-4 control-group" />
									  					</div>
														</div>
											...
											<cfelseif paymentDetails.paymentMethod.getPaymentMethodType() eq "creditCard">
												<div class="row">
													<div class="col-md-4">
														...
														<sw:AddressForm id="newBillingAddress" address="#addOrderPaymentObj.getNewOrderPayment().getBillingAddress()#" fieldNamePrefix="newOrderPayment.billingAddress." fieldClass="col-md-4" />
													</div>
													<div class="col-md-4">
								    					...
								    					<label for="creditCardNumber">Credit Card Number</label>
															<sw:FormField type="text" name="newOrderPayment.creditCardNumber" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="creditCardNumber" class="col-md-4 control-group" />
								    					...
								    					<label for="nameOnCreditCard">Name on Card</label>
															<sw:FormField type="text" name="newOrderPayment.nameOnCreditCard" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="nameOnCreditCard" class="col-md-4 control-group" />
															<p class="help-block"><sw:ErrorDisplay object="#addOrderPaymentObj.getNewOrderPayment()#" errorName="nameOnCreditCard" /></p>
								  					</div>
														...
														<div class="row">
															...
															<div class="col-md-2">
										    					...
										    					<label for="securityCode">Security Code</label>
																	<sw:FormField type="text" name="newOrderPayment.securityCode" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="securityCode" class="col-md-2 control-group" />
																	<p class="help-block"><sw:ErrorDisplay object="#addOrderPaymentObj.getNewOrderPayment()#" errorName="securityCode" /></p>
										  					</div>
															...
															<div class="col-md-2">
										    					...
										    					<label class="control-label pull-right" for="expirationMonth">Expiration ( MM / YYYY )</label>
																	<sw:FormField type="select" name="newOrderPayment.expirationMonth" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="expirationMonth" valueOptions="#addOrderPaymentObj.getNewOrderPayment().getExpirationMonthOptions()#" class="col-md-1 control-group" />
																	<sw:FormField type="select" name="newOrderPayment.expirationYear" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="expirationYear" valueOptions="#addOrderPaymentObj.getNewOrderPayment().getExpirationYearOptions()#" class="col-md-1 control-group" />
				...
				<div class="well">
					...
					<form action="?s=1" method="post">
						...
						<div class="form-group">
							...
							<sw:FormField type="password" valueObject="#createPasswordObj#" valueObjectProperty="password" class="col-md-4 control-group" />
							<p class="help-block"><sw:ErrorDisplay object="#createPasswordObj#" errorName="password" /></p>
						</div>

						<!--- Password Confirm --->
						<div class="form-group">
							<label for="rating">Confirm Password</label>
							<sw:FormField type="password" valueObject="#createPasswordObj#" valueObjectProperty="passwordConfirm" class="col-md-4 control-group" />
							<p class="help-block"><sw:ErrorDisplay object="#createPasswordObj#" errorName="passwordConfirm" /></p>
						</div>
