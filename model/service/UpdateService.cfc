...
<cfcomponent extends="HibachiService" accessors="true">
	...
	<cffunction name="update">
		...
		<cftry>
			...
			<cfset var deleteDestinationContentExclusionList = "/.git,/apps,/integrationServices,/custom,/WEB-INF,.project,setting.xml,settings.xml,.gitignore,web.config,.htaccess" />
