...
*/
 component  displayname="Promotion Account"  table="SWPromotionAccount"  persistent="true" accessors="true" entityname="SlatwallPromotionAccount" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" {
