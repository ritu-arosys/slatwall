...
*/
 component  displayname="AttributeSet" entityname="SlatwallAttributeSet" output="false"  table="SWAttributeSet"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="attributeService" hb_permission="this" {
