...
*/
 component  displayname="Price Group" entityname="SlatwallPriceGroup" output="false"  table="SWPriceGroup"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="priceGroupService" hb_permission="this" {
