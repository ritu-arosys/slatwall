...
*/
 component  displayname="App" entityname="SlatwallApp" output="false"  table="SWApp"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="appService" hb_permission="this" hb_processContexts="" {
