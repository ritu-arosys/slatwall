...
*/
 component  displayname="Brand" entityname="SlatwallBrand" output="false"  table="SWBrand"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="brandService" hb_permission="this" {
