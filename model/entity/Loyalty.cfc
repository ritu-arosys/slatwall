...
*/
 component  displayname="Loyalty" entityname="SlatwallLoyalty"  table="SWLoyalty"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="loyaltyService" hb_permission="this" {
