...
*/
 component  displayname="Address Zone" entityname="SlatwallAddressZone" output="false"  table="SWAddressZone"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="addressService" hb_permission="this" {
