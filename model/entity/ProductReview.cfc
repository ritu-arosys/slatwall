...
*/
 component  displayname="Product Review" entityname="SlatwallProductReview" output="false"  table="SWProductReview"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="productService" hb_permission="product.productReviews" {
