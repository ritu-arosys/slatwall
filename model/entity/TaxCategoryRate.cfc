...
*/
 component  entityname="SlatwallTaxCategoryRate" output="false"  table="SWTaxCategoryRate"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="taxService" hb_permission="taxCategory.taxCategoryRates" {
