...
*/
 component  displayname="Session" entityname="SlatwallSession" output="false"  table="SWSession"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="hibachiSessionService" hb_auditable="false" {
