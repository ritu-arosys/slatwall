...
*/
 component  entityname="SlatwallSubscriptionUsageBenefit"  table="SWSubscriptionUsageBenefit"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="subscriptionService" hb_permission="subscriptionUsage.subscriptionUsageBenefits" {
