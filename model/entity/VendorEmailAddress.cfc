...
*/
 component  entityname="SlatwallVendorEmailAddress"  table="SWVendorEmailAddress"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="vendorService" hb_permission="vendor.vendorEmailAddresses" {
