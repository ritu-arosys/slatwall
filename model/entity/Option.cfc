...
*/
 component  displayname="Option" entityname="SlatwallOption" output="false"  table="SWOption"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="optionService" hb_permission="optionGroup.options" {
