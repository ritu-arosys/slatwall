...
*/
 component  entityname="SlatwallShippingMethodRate" output="false"  table="SWShippingMethodRate"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="shippingService" hb_permission="shippingMethod.shippingMethodRates" {
