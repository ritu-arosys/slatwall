...
*/
 component  displayname="Rounding Rule" entityname="SlatwallRoundingRule" output="false"  table="SWRoundingRule"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="roundingRuleService" hb_permission="this" {
