...
*/
 component  displayname="Promotion Applied" entityname="SlatwallPromotionApplied" table="SWPromotionApplied"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" {
