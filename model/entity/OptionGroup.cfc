...
*/
 component  displayname="Option Group" entityname="SlatwallOptionGroup" output="false"  table="SWOptionGroup"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="optionService" hb_permission="this" {
