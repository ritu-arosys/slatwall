...
*/
 component  displayname="Attribute" entityname="SlatwallAttribute" output="false"  table="SWAttribute"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="attributeService" hb_permission="attributeSet.attributes" {
