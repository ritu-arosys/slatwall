...
*/
 component  entityname="SlatwallTaxCategory" output="false"  table="SWTaxCategory"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="taxService" hb_permission="this" {
