...
*/
 component  entityname="SlatwallTaskHistory" hb_auditable="false"  table="SWTaskHistory"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="scheduleService" {
