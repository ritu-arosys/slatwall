...
*/
 component  displayname="Address" entityname="SlatwallAddress" output="false"  table="SWAddress"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="addressService" hb_permission="this" {
