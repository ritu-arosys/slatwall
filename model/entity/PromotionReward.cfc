...
*/
 component  displayname="Promotion Reward" entityname="SlatwallPromotionReward"  table="SWPromotionReward"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" hb_permission="promotionPeriod.promotionRewards" {
