...
*/
 component  displayname="ProductSchedule" entityname="SlatwallProductSchedule" table="SWProductSchedule"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="productScheduleService" hb_permission="this" {
