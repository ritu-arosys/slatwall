...
*/
 component  entityname="SlatwallPermissionGroup" extends="HibachiEntity" table="SWPermissionGroup"  persistent="true" accessors="true" cacheuse="transactional" hb_serviceName="accountService" hb_permission="this" {
