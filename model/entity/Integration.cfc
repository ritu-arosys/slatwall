...
*/
 component  displayname="Integration" entityname="SlatwallIntegration" output="false"  table="SWIntegration"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="integrationService" hb_permission="this" hb_defaultOrderProperty="integrationName" {
