...
*/
 component  displayname="Loyalty Redemption" entityname="SlatwallLoyaltyRedemption"  table="SWLoyaltyRedemption"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="loyaltyService" hb_permission="this" hb_processContext="redeem" {
