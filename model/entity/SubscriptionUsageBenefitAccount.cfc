...
*/
 component  entityname="SlatwallSubscriptionUsageBenefitAccount"  table="SWSubscriptionUsageBenefitAccount"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="subscriptionService" hb_permission="subscriptionUsageBenefit.subscriptionUsageBenefitAccounts" {
