...
*/
 component  displayname="Promotion" entityname="SlatwallPromotion" table="SWPromotion"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="promotionService" hb_permission="this" {
