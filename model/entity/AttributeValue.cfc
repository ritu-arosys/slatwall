...
*/
 component  displayname="Attribute Value" entityname="SlatwallAttributeValue" output="false"  table="SWAttributeValue"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="attributeService" {
