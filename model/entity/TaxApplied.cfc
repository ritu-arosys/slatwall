...
Notes:
	...
	orderItem 
*/
 component  entityname="SlatwallTaxApplied" output="false"  table="SWTaxApplied"  persistent="true" accessors="true" extends="HibachiEntity" cacheuse="transactional" hb_serviceName="taxService" {
